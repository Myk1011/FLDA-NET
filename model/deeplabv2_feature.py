...
class DeeplabV2(ResNet):
    ...
    def forward(self, input):
        ...
        x_feature = self.layer3(x)
        x_second = self.layer4(x_feature)

        x1_first = self.aspp1_first(x_feature)
        x2_first = self.aspp2_first(x_feature)
        x3_first = self.aspp3_first(x_feature)
        x4_first = self.aspp4_first(x_feature)
        ...
        return x_first, x_second, x_feature
